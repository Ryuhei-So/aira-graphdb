...
- a schema removes affected fact/document associations and adjusts frequency/state, but is not silently deleted. Current Synapse reports `deletedSchemas = 0` (`c50e0754caf207eba1a0e2e2f377c56b47c10c4b:packages/memgraphrag/src/application/indexing/DeleteDocumentService.ts:60`).
